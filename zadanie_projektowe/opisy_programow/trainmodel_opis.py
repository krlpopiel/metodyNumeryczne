...
#lista modeli które będą użyte do klasyfikacji obrazów, obecnie wybrany jest model EfficientNet_B0
model_choice = 'efficientnet_b0'  # 'resnet50' 'vgg16', 'alexnet', 'efficientnet_b0'

#wskazanie jak ma zostać zmieniony obraz na wejściu
transform = transforms.Compose([ #połączenie trzech transformacji w jedno
