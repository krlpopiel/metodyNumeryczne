...
# Załaduj model
model_loader = ModelLoader()  # Utwórz instancję ModelLoader
model = model_loader.get_resnet50(pretrained=False)  # Załaduj model ResNet50 bez wstępnych wag
model.load_state_dict(torch.load('resnet50_album_classifier.pth'))  # Załaduj stan modelu
model.eval()
