...
dataset = AlbumDataset(
    plik_json='C:/Users/user/OneDrive/Desktop/kodowanie/MN/MN_projekt/metodyNumeryczne/zadanie_projektowe_test/annotations.json',  # Ścieżka do pliku JSON z etykietami
    zdjecia_kat='C:/Users/user/OneDrive/Desktop/kodowanie/MN/MN_projekt/metodyNumeryczne/zadanie_projektowe_test/images_900x600',  # Katalog ze zdjęciami
